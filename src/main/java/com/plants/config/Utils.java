...
public class Utils {
	 ...
	 * @param fileNameWithoutExt The name of the file without an extension (used as
	 *                           folder name)
	...
	public static ResponseEntity<Resource> getPathFileResponse(String baseDirectory, String folderName,
			String fileName) {
		try {
	...
	public static ResponseEntity<String> getImageUrl(String baseDirectory, String folderName, String fileName,
	...
	public static ResponseEntity<Map<String, Object>> createErrorResponse(Map<String, Object> response,
			String message) {
	...
	public static ResponseEntity<Map<String, Object>> createSuccessResponse(Map<String, Object> response,
			String message) {
	...
	public static String getAddressFromCoordinates(double latitude, double longitude, String apiKeyGoogle,
			String urlAddressGoogle) {
		RestTemplate restTemplate = new RestTemplate();

		String url = UriComponentsBuilder.fromHttpUrl(urlAddressGoogle).queryParam("latlng", latitude + "," + longitude)
				.queryParam("key", apiKeyGoogle).toUriString();
	 ...
	 */
	public static Map<String, String> buildPaginationUrls(String baseUrl, int currentPage, int totalPages, int pageSize,
		...
		if (dataList.isEmpty()) {
			...
			paginationUrls.put("first_page_url",
					totalPages > 0 ? baseUrl + "?pageNumber=1&pageSize=" + pageSize : null);
			paginationUrls.put("last_page_url",
					totalPages > 0 ? baseUrl + "?pageNumber=" + totalPages + "&pageSize=" + pageSize : null);
		}
		paginationUrls.put("next_page_url",
				currentPage < totalPages ? baseUrl + "?pageNumber=" + (currentPage + 1) + "&pageSize=" + pageSize
						: null);
		paginationUrls.put("prev_page_url",
				currentPage > 1 ? baseUrl + "?pageNumber=" + (currentPage - 1) + "&pageSize=" + pageSize : null);
	 ...
	 */
	public static <T> Map<String, Object> buildPaginationResponse(Page<T> pageData, String baseUrl, int pageSize,
			List<Map<String, Object>> dataList) {
	...
	public static Map<String, Object> buildPaginationResponse(List<Map<String, Object>> ordersList, String baseUrl,
			int pageNumber, int pageSize, List<Map<String, Object>> ordersList2) {
