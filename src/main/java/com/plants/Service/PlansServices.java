...
public class PlansServices {
	...
	public ResponseEntity<Map<String, Object>> viewService() {
	...
	public ResponseEntity<Map<String, Object>> addService(@RequestBody Map<String, String> request) {
		Map<String, Object> response = new HashMap<>();
	...
	public ResponseEntity<Map<String, Object>> includingServiceActive(@RequestBody Map<String, String> request) {
		...
		try {
			...
			ServiceIncludedMain serviceIncludedMain = this.serviceIncludedMainRepo.getPkIncludingServiceMain(primaryKey);
	...
	public ResponseEntity<Map<String, Object>> addPlans(String plansJson, MultipartFile planImage) {
	    ...
	    try {
	      ...
	      //set image Name
	        ...
	        List<IncludingService> includingServices = plans.getIncludingServicesList().stream()
	        	    .map(serviceDto -> {
